        ...
        <>
            <div className="contact p-5 d-flex flex-column justify-content-around">
                ...
                <div className={`contact-body m-3 p-2 d-flex ${locationClicked ? "translatelocation" : ""} `}>
                    <div className="location d-flex flex-column justify-content-between me-3 align-items-center">
                        <div className='location-text'>
                            <div className="location-head text-center my-3">
                                Our Showroom
                            </div>
                            <div className="location-desc text-center">
                            G22H+G73, Block C 1, Palam Vihar, <br />  Gurugram,Haryana 122017 
                            </div>
                        </div>
                        <div className='my-5 location-data'>
                            <iframe title="Google Maps"
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d56100.4086563768!2d76.99100143977465!3d28.50135655006879!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d19edefffb9c5%3A0xe8ab971c5099bc44!2sRao%20Builders!5e0!3m2!1sen!2sin!4v1705877759304!5m2!1sen!2sin" style={{ border: 0 }} allowFullScreen="" aria-hidden="false" tabIndex="0"></iframe>
                        </div>
                    </div>
